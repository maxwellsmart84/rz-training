...
var ManyToManyUpdateSqliteOperation = function (_UpdateOperation) {
  ...
  function ManyToManyUpdateSqliteOperation(builder, name, opt) {
    (0, _classCallCheck3.default)(this, ManyToManyUpdateSqliteOperation);

    var _this = (0, _possibleConstructorReturn3.default)(this, _UpdateOperation.call(this, builder, name, opt));
